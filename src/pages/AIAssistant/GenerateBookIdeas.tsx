...
import { BookOpen, Wand2, Save, AlertCircle } from 'lucide-react';
...
const GenerateBookIdeas = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<BookIdeaForm>({
    defaultValues: {
    ...
    try {
      ...
      const response = await generateIdeas({
        ...
        information: {
          ...
          specificElements: data.specificElements,
        ...
        <div className="max-w-[1400px] mx-auto p-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Generate Book Ideas</h1>
                <p className="text-gray-600">Create unique book concepts tailored to your preferences</p>
              </div>
            </div>
          </motion.div>
            ...
            >
              <Card className="bg-white/50 backdrop-blur-sm ">
                ...
                <CardHeader>
                  ...
                  <CardDescription>Define your book's characteristics</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            >
              ...
              <Card className="bg-white/50 backdrop-blur-sm ">
                ...
                <CardHeader>
                  ...
                  <CardDescription>AI-generated book concepts based on your parameters</CardDescription>
                </CardHeader>
                <CardContent>
                    {generatedContent ? (
