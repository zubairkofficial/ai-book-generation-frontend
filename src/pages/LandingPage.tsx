      ...
      <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 border-b">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Ai Book Legacy Generation AI</span>
          </div>
            ...
            {[
              {
                name: "Sarah Johnson",
                role: "Fantasy Author",
                content: "Ai Book Legacy Generation AI transformed my writing process. The AI suggestions and image generation are incredible!",
                rating: 5
              },
              {
                name: "Michael Chen",
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-gray-300">Join the future of book creation with Ai Book Legacy Generation AI</p>
            <Link to="/auth">
              <Button size="lg" className="bg-amber-500 hover:bg-amber-600">
